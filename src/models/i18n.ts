...
export interface AuthAndVaultTranslations {
  ...
  authVerifyingPassword: string;
  authServerUnreachable: string;
  authTimeoutError: string;
  ...
  adminTabGemini: string;
  geminiConfigTitle: string;
  geminiConfigSubtitle: string;
  geminiStatusConnected: string;
  geminiStatusNotConfigured: string;
  geminiStatusError: string;
  geminiStatusChecking: string;
  geminiValidateBtn: string;
  geminiValidatingBtn: string;
  geminiSaveBtn: string;
  geminiSavingBtn: string;
  geminiApiKeyLabel: string;
  geminiApiKeyPlaceholder: string;
  geminiApiKeyConfiguredBadge: string;
  geminiApiKeyNotConfiguredBadge: string;
  geminiApiKeyClearBtn: string;
  geminiApiKeyHelp: string;
  geminiStudioLink: string;
  geminiModelLabel: string;
  geminiModelHelp: string;
  geminiProviderLabel: string;
  geminiRpmLimitLabel: string;
  geminiRpmLimitHelp: string;
  geminiMaxWorkersLabel: string;
  geminiMaxWorkersHelp: string;
  geminiLatencyLabel: string;
  geminiLastTestedLabel: string;
  geminiDiagTitle: string;
  geminiSuccessToast: string;
  geminiClearedToast: string;
  geminiErrorToast: string;
